...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:ip:clk_wiz:5.1\
xilinx.com:ip:axi_protocol_converter:2.1\
xilinx.com:ip:processing_system7:5.4\
...
xilinx.com:ip:util_vector_logic:1.0\
...
BSL.local:user:myip_shifter:1.12\
xilinx.com:ip:axi_bram_ctrl:4.0\
xilinx.com:ip:blk_mem_gen:8.2\
...
proc create_hier_cell_microblaze_core { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S0_AXI_BASEADDR {0x43600000} \
   CONFIG.C_S0_AXI_HIGHADDR {0x4360FFFF} \
   CONFIG.C_S1_AXI_BASEADDR {0x41001000} \
   CONFIG.C_S1_AXI_HIGHADDR {0x41001FFF} \
 ] $mailbox
...
CONFIG.HAS_BRESP {1} \
CONFIG.HAS_RRESP {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/mdm_1/S_AXI]
...
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/M0_AXIS]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {4} \
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/M1_AXIS]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {4} \
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/M2_AXIS]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {4} \
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/S0_AXIS]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {4} \
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/S1_AXIS]

  set_property -dict [ list \
CONFIG.TDATA_NUM_BYTES {4} \
CONFIG.HAS_TREADY {1} \
CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /microblaze_ppu/microblaze_core/microblaze_0/S2_AXIS]
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set bram_d [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.2 bram_d ]
  set_property -dict [ list \
  ...
  set bram_i [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.2 bram_i ]
  set_property -dict [ list \
   CONFIG.Enable_B {Use_ENB_Pin} \
   CONFIG.Memory_Type {True_Dual_Port_RAM} \
   CONFIG.Port_B_Clock {100} \
  ...
  set bram_p [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.2 bram_p ]
  set_property -dict [ list \
   CONFIG.Memory_Type {True_Dual_Port_RAM} \
 ] $bram_p
...
proc create_hier_cell_pulse_gen_1 { parentCell nameHier } {
  ...
  set util_vector_logic_not [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_logic_not ]
  set_property -dict [ list \
  ...
  set util_vector_logic_not2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_logic_not2 ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
...
CONFIG.TDATA_NUM_BYTES {9} \
  ...
  set not_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 not_reset ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
 ] $not_reset
  ...
  set not_reset1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 not_reset1 ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
 ] $not_reset1
  ...
  set util_vector_and [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_and ]
  set_property -dict [ list \
  ...
  set util_vector_not [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_not ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
 ] $util_vector_not
...
proc create_hier_cell_TTL { parentCell nameHier } {
  ...
  # Create instance: xlslice_31_28_generic_3_1, and set properties
  set xlslice_31_28_generic_3_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_31_28_generic_3_1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {28} \
...
proc create_hier_cell_DDS_AD9951 { parentCell nameHier } {
  ...
  set util_or_swt_en [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_or_swt_en ]
  set_property -dict [ list \
  ...
  set util_vector_logic_or_ioupdate [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_logic_or_ioupdate ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {or} \
   CONFIG.C_SIZE {1} \
...
proc create_hier_cell_ADC_LTC2207 { parentCell nameHier } {
  ...
  set util_vector_b0and [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 util_vector_b0and ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {and} \
   CONFIG.C_SIZE {1} \
 ] $util_vector_b0and
  ...
  set utl_or_run [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:1.0 utl_or_run ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {or} \
   CONFIG.C_SIZE {1} \
 ] $utl_or_run
...
proc create_root_design { parentCell } {
  ...
  set FPGA_CLKin [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 FPGA_CLKin ]
  set_property -dict [ list \
  ...
  set azynq_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.4 azynq_0 ]
  set_property -dict [ list \
   ...
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.294} \
   ...
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {-0.072} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {0.024} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {0.023} \
...
CONFIG.HAS_BRESP {1} \
CONFIG.HAS_RRESP {1} \
 ] [get_bd_intf_pins /azynq_0/M_AXI_GP0]
...
CONFIG.HAS_BRESP {1} \
CONFIG.HAS_RRESP {1} \
 ] [get_bd_intf_pins /azynq_0/S_AXI_HP0]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41001000 [get_bd_addr_spaces azynq_0/Data] [get_bd_addr_segs microblaze_ppu/microblaze_core/mailbox/S1_AXI/S1_AXI_Reg] SEG_mailbox_S1_AXI_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43600000 [get_bd_addr_spaces microblaze_ppu/microblaze_core/microblaze_0/Data] [get_bd_addr_segs microblaze_ppu/microblaze_core/mailbox/S0_AXI/S0_AXI_Reg] SEG_mailbox_0_S0_AXI_Reg
