...
class Experiment(BaseExperiment):  # must be named 'Experiment'
    ...
    async def run(self, progress_handler=None, message_handler=None):
        self.programs['DIFF1D'].set_par('echo_shift', self.par['echo_shift'] + self.par['sample_shift'])
        await self.programs['DIFF1D'].run(progress_handler=progress_handler,
    ...
    def raw_data(self):
        data = self.programs['DIFF1D'].data.view(np.complex64)
        return data
