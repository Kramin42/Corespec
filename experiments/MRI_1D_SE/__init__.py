...
class Experiment(BaseExperiment):  # must be named 'Experiment'
    ...
    async def run(self, progress_handler=None, message_handler=None):
        self.programs['MRI_1D'].set_par('phase_GX', 0)
        self.programs['MRI_1D'].set_par('phase_GY', 0)
        self.programs['MRI_1D'].set_par('phase_GZ', 0)
        await self.programs['MRI_1D'].run(progress_handler=progress_handler,
    ...
    def raw_data(self):
        return self.programs['MRI_1D'].data.view(np.complex64)
