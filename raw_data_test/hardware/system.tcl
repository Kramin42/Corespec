...
proc create_hier_cell_ddc { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_2_M_AXIS [get_bd_intf_pins axis_dwidth_converter_2/M_AXIS] [get_bd_intf_pins dma_con/S_AXIS_S2MM]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  # Create port connections
  connect_bd_net -net CLK_1 [get_bd_pins CLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_dwidth_converter_2/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins cic_compiler_x/aclk] [get_bd_pins cic_compiler_y/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dma_con/m_axi_s2mm_aclk] [get_bd_pins dma_con/s_axi_lite_aclk] [get_bd_pins gpio_DDC_control/s_axi_aclk] [get_bd_pins gpio_DDC_fifo/s_axi_aclk] [get_bd_pins gpio_DDS/s_axi_aclk] [get_bd_pins myip_shifter_x/aclk] [get_bd_pins myip_shifter_y/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_dwidth_converter_2/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins dma_con/axi_resetn] [get_bd_pins gpio_DDC_control/s_axi_aresetn] [get_bd_pins gpio_DDC_fifo/s_axi_aresetn] [get_bd_pins gpio_DDS/s_axi_aresetn] [get_bd_pins util_vector_and/Op1]
  ...
  connect_bd_net -net axis_register_slice_0_m_axis_tdata [get_bd_pins axis_dwidth_converter_2/s_axis_tdata] [get_bd_pins axis_register_slice_0/m_axis_tdata] [get_bd_pins mult_gen_x/A] [get_bd_pins mult_gen_y/A]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets axis_register_slice_0_m_axis_tdata]
  connect_bd_net -net axis_register_slice_0_m_axis_tvalid [get_bd_pins axis_dwidth_converter_2/s_axis_tvalid] [get_bd_pins axis_register_slice_0/m_axis_tvalid] [get_bd_pins cic_compiler_x/s_axis_data_tvalid] [get_bd_pins cic_compiler_y/s_axis_data_tvalid]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
